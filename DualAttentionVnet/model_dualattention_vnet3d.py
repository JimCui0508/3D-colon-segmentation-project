...
'''
from layer import conv3d, deconv3d, normalizationlayer, crop_and_concat, resnet_Add, weight_xavier_init,bias_variable
...
def createdualattentionnet(X, image_z, image_width, image_height, image_channel, phase, drop, n_class=1):
